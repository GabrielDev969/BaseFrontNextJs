...
import { ArrowLeft } from 'lucide-react'; // Importamos o ícone
  ...
  return (
    <main className="relative flex min-h-screen flex-col items-center justify-center p-4 sm:p-6 bg-gray-50 overflow-x-hidden w-full">
      ...
      <div className="mb-6 sm:mb-8 text-center w-full max-w-sm">
        ...
        <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 tracking-tight">Bem-vindo de volta</h1>
        <p className="text-gray-600 mt-2 text-xs sm:text-sm px-4">
          Gerencie seus projetos e acompanhe métricas em um só lugar.
        </p>
      </div>
      ...
      <p className="mt-6 sm:mt-8 text-center text-xs text-gray-400 px-4">
        © {new Date().getFullYear()} CleanNext Project. Protegido por reCAPTCHA.
      </p>
    </main>
  );
}